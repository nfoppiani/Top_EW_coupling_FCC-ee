...
eosDir=/store/cmst3/user/pjanot/ttbar365Wizard/yyxyev/
...
for ((job=1;job<3;job++));
  ...
  # eos cp -r root://castorcms////castor/cern.ch/grid/ilc/prod/clic/365gev/yyveyx_o/ILD/REC/00005251/000/ /store/cmst3/user/pjanot/ttbar365Wizard/yyxyev/
done
