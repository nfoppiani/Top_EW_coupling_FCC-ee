			...
			if pdgId==11 or pdgId==-11:
				...
				if pa0 != -1:
					if tree.mcpdg[pa0]==24 or tree.mcpdg[pa0]==-24:
						if tree.mcmas[pa0]>75 and tree.mcmas[pa0]<85:
...
mc_e_mu_energy_histo = TFile("./../plot/lepton_distribution_with_wmass_cut_histo.root","CREATE")
h_EL.Write()
h_MU.Write()
h_ELplusMU.Write()
...
mc_e_mu_energy_histo = TFile("./../plot/lepton_distribution_with_wmass_cut_canvas.root","CREATE")
c_EL.Write()
c_MU.Write()
c_ELplusMU.Write()
