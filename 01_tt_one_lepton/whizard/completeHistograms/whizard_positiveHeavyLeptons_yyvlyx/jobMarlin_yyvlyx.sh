...
eosDir1=/store/cmst3/user/tpajero/ttbar365Whizard/yyvlyx/000/
#eosDir2=/store/cmst3/user/tpajero/ttbar365Whizard/yyvlyx/001/

# 999 files (from 1 to 999)
# 419 files (from 1000 to 1418)

for ((job=1;job<2;job++));
  do
  echo "JOB "$job
  name="yyvlyx_wizard_o_"${job}
  slcioFilename="yyvlyx_o_rec_5233_"${job}".slcio"
  ntupleFilename="yyvlyx_o_"${job}".root"
