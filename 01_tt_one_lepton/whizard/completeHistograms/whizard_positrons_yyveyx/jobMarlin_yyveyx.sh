...
eosDir1=/store/cmst3/user/nfoppian/ttbar365Wizard/yyveyx/
eosDir2=/store/cmst3/user/tpajero/ttbar365Whizard/yyveyx/

# 672 files (from 1 to 672)
# 618 and 667 files do not exist!

for ((job=1;job<3;job++));
  do
  echo "JOB "$job
  name="yyveyx_wizard_o_"${job}
  slcioFilename="yyveyx_o_rec_5251_"${job}".slcio"
  ntupleFilename="yyveyx_o_"${job}".root"
