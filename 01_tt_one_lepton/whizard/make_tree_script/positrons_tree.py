...
chain.Add("/afs/cern.ch/user/t/tpajero/work/public/whizard_positron_yyveyx/yy*.root")

# creates the new file and the tree that it will contain
savingFile = TFile("../tree/positrons_tree.root", "CREATE")
positronsTree = TTree('positrons_tree', 'reducedInformationTree')
...
positronsTree.Branch('mcTyp', mcTyp, 'mcTyp/D')
positronsTree.Branch('mcEne', mcEne, 'mcEne/D')
positronsTree.Branch('mcRedEne', mcRedEne, 'mcRedEne/D')
positronsTree.Branch('mcMox', mcMox, 'mcMox/D')
positronsTree.Branch('mcMoy', mcMoy, 'mcMoy/D')
positronsTree.Branch('mcMoz', mcMoz, 'mcMoz/D')
positronsTree.Branch('mcCosTheta', mcCosTheta, 'mcCosTheta/D')
positronsTree.Branch('mcInvMas', mcInvMas, 'mcInvMas/D')
...
savingFile.cd()
positronsTree.Write()         # writes the tree in the savingFile
savingFile.Close()
