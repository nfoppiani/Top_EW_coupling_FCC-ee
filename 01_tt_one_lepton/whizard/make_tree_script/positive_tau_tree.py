...
savingFile = TFile("../tree/positive_tau_tree.root", "CREATE")
positive_tauTree = TTree('positive_tau_tree', 'reducedInformationTree')
...
positive_tauTree.Branch('mcTyp', mcTyp, 'mcTyp/D')
positive_tauTree.Branch('mcEne', mcEne, 'mcEne/D')
positive_tauTree.Branch('mcRedEne', mcRedEne, 'mcRedEne/D')
positive_tauTree.Branch('mcMox', mcMox, 'mcMox/D')
positive_tauTree.Branch('mcMoy', mcMoy, 'mcMoy/D')
positive_tauTree.Branch('mcMoz', mcMoz, 'mcMoz/D')
positive_tauTree.Branch('mcCosTheta', mcCosTheta, 'mcCosTheta/D')
positive_tauTree.Branch('mcInvMas', mcInvMas, 'mcInvMas/D')
...
for event in chain:
	...
	if chain.mcpdg[9]==-15:
		...
		positive_tauTree.Fill()        

savingFile.cd()
positive_tauTree.Write()         # writes the tree in the savingFile
savingFile.Close()
