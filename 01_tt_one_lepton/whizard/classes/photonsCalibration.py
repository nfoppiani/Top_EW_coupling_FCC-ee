...
fileList = glob.glob('./../whizard_electron_yyxyev/yyxyev_o_*1.root')
...
for fileName in fileList:
    ...
    for event in tree:
        ...
        for i in range(len(tree.mcpdg)):
            if tree.mcpdg[i] == 11 and tree.mcene[i] > electronMatchMinEnergy and i > 2:
...
print
print 'not found', err
print 'tot mean distance', sum/n
print 'not found decays', errDecay
print 'tot mean decay distance', sumDecay/nDecay
