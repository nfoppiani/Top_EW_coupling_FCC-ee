...
hPhotonDistributionW = TH2F("photonDistributionW", "Emitted photons distribution", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
hPhotonDistributionNotW = TH2F("photonDistributionNotW", "Emitted photons distribution", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
hPhotonDistributionWEnergy = TH2F("photonDistributionWPhoton", "Emitted photons distribution weighted on the photons energy", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
hPhotonDistributionNotWEnergy = TH2F("photonDistributionNotWPhotonEnergy", "Emitted photons distribution weighted on the photons energy", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
hPhotonDistributionWMuonEnergy = TH2F("photonDistributionWMuonEnergy", "Emitted photons distribution weighted on the muons energy", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
hPhotonDistributionNotWMuonEnergy = TH2F("photonDistributionNotWMuonEnergy", "Emitted photons distribution weighted on the muons energy", 100,dthetaDegrees, dthetaDegrees, 100, -dphiDegrees, dphiDegrees)
